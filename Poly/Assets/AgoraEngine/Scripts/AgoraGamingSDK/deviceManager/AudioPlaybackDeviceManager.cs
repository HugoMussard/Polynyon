...
namespace agora_gaming_rtc
{
    ...
    public sealed class AudioPlaybackDeviceManager : IAudioPlaybackDeviceManager
    {
        ...
        * 
        * @note Ensure that you call {@link agora_gaming_rtc.AudioPlaybackDeviceManager.StopAudioPlaybackDeviceTest StopAudioPlaybackDeviceTest} after calling this method.
        * 
